...
namespace custom_data_structures {
    ...
    public:
        ...
        void emplace_back(Args&&... args) {
            ...
            alloc_traits::construct(_alloc, &back(), std::forward<Args>(args)...);
        }

        void push_back(const T& element) {
            prepare_to_push_back();
            alloc_traits::construct(_alloc, &back(), element);
        }
        ...
        void emplace_front(Args&&... args) {
            ...
            alloc_traits::construct(_alloc, &front(), std::forward<Args>(args)...);
        }

        void push_front(const T& element) {
            prepare_to_push_front();
            alloc_traits::construct(_alloc, &front, element);
        }
        ...
        void resize(size_t new_size) {
            if (new_size < _size) {
                throw std::invalid_argument("The number of elements should not be larger than the new size");
            }
